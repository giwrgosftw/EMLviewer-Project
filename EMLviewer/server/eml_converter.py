...
# Set-up the content of the text file and returns the final txt file
def create_text_file(txt_file, email_dict):
    ...
    txt_file += "From: " + from_ + "\n"
    txt_file += "To: " + to_ + "\n"
    txt_file += "Subject: " + subject + "\n"
    txt_file += "Date: " + date + "\n\n"
    txt_file += "Attachments: " + ", ".join(files) + "\n"
    txt_file += "Parts: " + str(parts) + "\n\n"
    txt_file += "Text:\n\n" + txt + "\n\n"
    txt_file += "HTML:\n\n" + html
    return txt_file
...
def main():
    for i in os.listdir("."):
        if i.endswith(".eml"):
            ...
            f_attach = open(i, "rb")
            email_dict = extract(f_attach, f_attach.name)
            f_attach.close()

            text_file = ""
            text_file = create_text_file(text_file, email_dict)

            w_text = open("/tmp/" + nam + ".txt", "w")
            w_text.write(text_file)
            w_text.close()
