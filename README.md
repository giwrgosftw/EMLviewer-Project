...
# Notes
My virtualenv (venv) folder is not uploaded, so please check the requirements.txt file in the EMLviewer folder in order to see the packages which I have installed. Then, on your production server, create the virtual environment and run pip install -r requirements.txt .
